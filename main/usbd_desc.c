...
#define USBD_MANUFACTURER_STRING      "IMGe Team"

#define USBD_PRODUCT_HS_STRING        "IMGe Device"
#define USBD_SERIALNUMBER_HS_STRING   "Proto 0.4"

#define USBD_PRODUCT_FS_STRING        "IMGe Device"
#define USBD_SERIALNUMBER_FS_STRING   "Proto 0.4"
